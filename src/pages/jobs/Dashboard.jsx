...
const Dashboard = () => {
  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: '#f9f9f9' }}>
      <div style={{ padding: '40px 40px 16px', maxWidth: '1200px', margin: '0 auto' }}>
        <h1 
          style={{ 
        ...
        {!preferences && (
            <Alert className="mb-6 border-amber-200 bg-amber-50">
                ...
                <AlertDescription className="text-amber-700">
                    To activate intelligent matching and see Match Scores, please <Link to="/career/settings" className="font-semibold underline">configure your settings</Link>.
                </AlertDescription>
            </Alert>
        )}
