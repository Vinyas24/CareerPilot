          ...
          <div className="mb-8 p-4 bg-amber-50 border border-amber-200 rounded-lg flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-amber-700 mt-1">
                {testsPassed} / 10 tests passed. Complete all tests at <a href="/career/jt/07-test" className="underline font-medium">/career/jt/07-test</a> to mark project as shipped.
              </p>
            </div>
          </div>
        )}
